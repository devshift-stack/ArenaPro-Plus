...
export const ALL_MODELS = [
  // ══════════════════════════════════════════════════════════════════════════
  // FREE TIER - Standardmäßig für alle User verfügbar
  // ══════════════════════════════════════════════════════════════════════════
  {
  ...
  },
  {
    ...
    name: 'GPT-4o',
    provider: 'OpenAI',
    description: 'Optimiert für Geschwindigkeit und Qualität',
  ...
  },
  {
    ...
    name: 'GPT-4 Turbo',
    provider: 'OpenAI',
    description: 'Leistungsstarkes Modell mit Vision',
  ...
  },
  {
    ...
    provider: 'Anthropic',
    description: 'Neuestes und bestes Claude Modell',
    capabilities: ['reasoning', 'coding', 'analysis', 'creative'],
    contextWindow: 200000,
    costPerInputToken: 0.000003,
    costPerOutputToken: 0.000015,
