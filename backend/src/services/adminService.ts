...
export const ALL_MODELS = [
  // ══════════════════════════════════════════════════════════════════════════
  // FREE TIER - Standardmäßig für alle User verfügbar (mit :free Suffix)
  // ══════════════════════════════════════════════════════════════════════════
  {
    id: 'meta-llama/llama-3.2-3b-instruct:free',
    name: 'Llama 3.2 3B',
    provider: 'Meta',
    description: 'Kleines aber effizientes Llama-Modell (kostenlos)',
  ...
  },
  {
    ...
    name: 'Mistral 7B',
    provider: 'Mistral',
    description: 'Effizientes Open-Source Modell (kostenlos)',
  ...
  },
  {
    ...
    name: 'Gemma 3 4B',
    provider: 'Google',
    description: 'Kleines Google-Modell (kostenlos)',
    capabilities: ['chat', 'simple-tasks'],
    contextWindow: 32000,
    costPerInputToken: 0,
    costPerOutputToken: 0,
  ...
  },
  {
    ...
    name: 'Llama 3.1 8B',
    provider: 'Meta',
    description: 'Schnelles Llama-Modell, sehr günstig',
    capabilities: ['chat', 'reasoning'],
    contextWindow: 131072,
    costPerInputToken: 0.00000002,
    costPerOutputToken: 0.00000003,
    tier: 'FREE',
    isDefault: true,
  },
