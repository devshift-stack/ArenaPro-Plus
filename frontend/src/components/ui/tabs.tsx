  ...
  <TabsPrimitive.List
    ...
    className={cn(
      `inline-flex h-10 items-center justify-center rounded-md 
       bg-slate-800 p-1 text-slate-400`,
      className
    )}
    {...props}
  />
  ...
  <TabsPrimitive.Trigger
    ...
    className={cn(
      `inline-flex items-center justify-center whitespace-nowrap rounded-sm 
       px-3 py-1.5 text-sm font-medium ring-offset-slate-900 transition-all 
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      `mt-2 ring-offset-slate-900 focus-visible:outline-none 
